...
#bellatrix bewitch specific configurations:
#bellatrix bewitch is a macro command will start an instance, provision it and finally burn it. 
#You can achieve the same results using the start, provision and then burn commands.   
